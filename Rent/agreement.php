...
<div id="wrapper">
	...
	<div>
<div style="float:left; width:45%; height: 163px; padding:0 0 0 3px; border:1px solid #000;">
...
<div style="float:left; width:51%; height: 163px; padding:0 0 0 3px; margin-left: 10px; border:1px solid #000;">
<pre style="line-height: 18px">
...
ต้องชดใช้เงิน 500 บาท</pre>
			...
			<div>
<div style="float:left; width:45%; height: 110px; padding:0 0 0 3px; margin-top: 7px; border:1px solid #000;">
<pre style="line-height: 18px">
<b>รายการที่เช่า</b>
...
<div style="float:left; width:51%; height: 110px; padding:0 0 0 3px; margin-top: 7px; margin-left: 10px; border:1px solid #000;">
<pre style="line-height: 18px">
...
ถึงเวลา 13:00 น. ของวันถัดไป)</pre>
		...
		<p style="line-height: 22px; padding-top: 50px" >คู่สัญญาได้อ่านข้อความในสัญญาเช่า รวมทั้งประกาศศูนย์คอมพิวเตอร์ เรื่องข้อกำหนดการเช่าเครื่องคอมพิวเตอร์<br> ชนิดพกพา (Notebook) และเข้าใจข้อความโดยละเอียดแล้ว ยอมรับเงื่อนไขทุกประการ จึงได้ลงลายมือชื่อไว้เป็นหลักฐาน</p>
