                    ...
                    <div>
                        <h3><b>หลักเกณฑ์การเช่า</b></h3>
                            <ol style="font-size: 18px">
                                <li>
                                    ผู้เช่าต้องเป็นนักศึกษาหรือบุคลากรในมหาวิทยาลัยสงขลานคริทร์เท่านั้น
                                </li>
                                <li>
                                ...
                                <li>
                                    หากสติกเกอร์ของชิ้นส่วนอุปกรณ์มีการแกะ หรือฉีกขาด ต้องชดใช้เงิน 500 บาท
                                </li>
                            </ol>                    
                    </div>
                    <div>
                    ...
                    <div>
                        <h3><b>อัตราค่าเช่า/ค่าปรับ</b></h3>
                            <ol style="font-size: 18px">
                                ...
                                <li>
                                    กรณีส่งคืนหลังเวลาที่กำหนด คิดค่าปรับวันละ 500 บาท
                                </li>
                            </ol>                       
                    </div>
                    <br>
