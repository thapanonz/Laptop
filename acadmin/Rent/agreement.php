...
ลงชื่อ                                             
<div style="padding-top: 7px; padding-left: 20px;"><div style="background-color:#CCC; text-align: center; padding: 2px 0 2px 0"><?php echo $row["prename"].$row["firstname"].' '.$row["lastname"] ?></div></div><div style="padding-top: 4px; text-align:center">ผู้เช่า</div><div style="padding-top: 18px; padding-left: 20px; text-align:left">ลงชื่อ __________________________ ผู้คืน</div></pre>
			</div>
